...
namespace Capa_de_Presentacion
{
    public partial class FrmRegistroVentas : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        private void FrmVentas_Load(object sender, EventArgs e)
        {
            ...
            //    if (time.Seconds == 15)
            //    {
            //        DevComponents.DotNetBar.MessageBoxEx.Show("Supero el tiempo de espera de la ventana de Ventas", "Sistema de Ventas.", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //        this.Close();
            //    }
            //};
        ...
        private void btnRegistrarVenta_Click(object sender, EventArgs e)
        {
            ...
            //CDA05
            this.Close();
            //ESTE CLOSE DE LA VENTANA ES PARA EVITAR QUE SIGA ABIERTA Y AL CREAR OTRA FACTURA NO ME TRAIGA DATOS EN LA GRILLA DE LA VENTA ANTERIOR.
        }
